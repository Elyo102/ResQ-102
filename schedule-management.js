...
import { renderNav, renderStuckNav } from './nav.js?v=42h26';
import { initPWA, registerPwaUpdateGuard } from './pwa.js?v=42h26';
import { schedulePwaUpdateGuard } from './schedule-update-guard.js?v=42h26';
import { initAppCheck } from './appcheck.js?v=42h26';
import { readScheduleFile } from './schedule-file-import.js?v=42h26';
import { renderModeBar, TRIAL_PUBLISH_WARNING } from './mode-bar.js?v=42h26';
...
import { consumeActualRoleViewNavigation, resolvePageRoleView } from './role-view-page.js?v=42h26';
