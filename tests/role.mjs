...
const EXPECT = {
  ...
  super:       { nav:['לוח מודעות','סידור','קריאת פתע','נוכחות','תקלות','טפסים','החלפות','חוות דעת','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','משאבי אנוש','גישה','ניהול','נתונים','קליטה','בדיקה','תחזוקת מערכת','ארגונים ומנויים','מדדים תפעוליים'],
  ...
  commander:   { nav:['לוח מודעות','סידור','קריאת פתע','נוכחות','תקלות','טפסים','החלפות','חוות דעת','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','גישה','נתונים'],
                 adminSees:[],
                 shadow:false,
                 quals:{ work:true, edit:true },
                 ...
                 faults:{ work:true, anchor:true, sev:true, grade:true },
                 forms:{ work:true, appr:true, count:4 }, stats:true },
  hr:          { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','חוות דעת','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','משאבי אנוש','גישה','נתונים'],
                 adminSees:[],
                 shadow:true,
                 quals:{ work:true, edit:true },
  ...
  deputy:      { nav:['לוח מודעות','סידור','קריאת פתע','נוכחות','תקלות','טפסים','החלפות','חוות דעת','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','גישה','נתונים'],
                 adminSees:[],
                 shadow:false,
                 quals:{ work:true, edit:true },
                 board:{ work:true, edit:true }, crews:['B'],
  ...
  stcmd:       { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','חוות דעת','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','גישה','נתונים'],
                 adminSees:[],
                 shadow:true,
                 quals:{ work:true, edit:true },
                 board:{ work:true, edit:true }, crews:['A','B','C'],
