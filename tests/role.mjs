...
const EXPECT = {
  ...
  super:       { nav:['לוח מודעות','סידור','קריאת פתע','נוכחות','תקלות','טפסים','החלפות','חוות דעת','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','משאבי אנוש','גישה','ניהול','נתונים','קליטה','בדיקה','תחזוקת מערכת'],
