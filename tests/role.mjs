...
const EXPECT = {
  ...
  super:       { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','גישה','ניהול','נתונים','קליטה','בדיקה'],
  ...
  firefighter: { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים'], adminSees:[],
                 shadow:false,
  ...
  commander:   { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','גישה','ניהול','נתונים'],
                 adminSees:[],
                 shadow:false,
                 quals:{ work:true, edit:true },
  ...
  deputy:      { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','גישה','ניהול','נתונים'],
                 adminSees:[],
                 shadow:false,
                 quals:{ work:true, edit:true },
                 board:{ work:true, edit:true }, crews:['B'],
  ...
  stcmd:       { nav:['לוח מודעות','סידור','נוכחות','תקלות','טפסים','החלפות','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','גישה','ניהול','נתונים'],
                 adminSees:[],
                 shadow:true,
                 quals:{ work:true, edit:true },
                 board:{ work:true, edit:true }, crews:['A','B','C'],
