...
const EXPECT = {
  ...
  super:       { nav:['לוח מודעות','נוכחות','תקלות','טפסים','החלפות','סידור התחנה','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','גישה','ניהול','נתונים','קליטה','בדיקה'],
  ...
  firefighter: { nav:['לוח מודעות','נוכחות','תקלות','טפסים','החלפות','סידור התחנה','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים'], adminSees:[],
                 shadow:false,
  ...
  commander:   { nav:['לוח מודעות','נוכחות','תקלות','טפסים','החלפות','סידור התחנה','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','גישה','נתונים'],
                 adminSees:[],
                 shadow:false,
                 quals:{ work:true, edit:true },
                 ...
                 faults:{ work:true, anchor:true, sev:true, grade:true },
                 forms:{ work:true, appr:true, count:4 }, stats:true },
  hr:          { nav:['לוח מודעות','נוכחות','תקלות','טפסים','החלפות','סידור התחנה','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','גישה','נתונים'],
                 adminSees:[],
                 shadow:true,
                 quals:{ work:true, edit:true },
  ...
  deputy:      { nav:['לוח מודעות','נוכחות','תקלות','טפסים','החלפות','סידור התחנה','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','גישה','נתונים'],
                 adminSees:[],
                 shadow:false,
                 quals:{ work:true, edit:true },
                 board:{ work:true, edit:true }, crews:['B'],
  ...
  stcmd:       { nav:['לוח מודעות','נוכחות','תקלות','טפסים','החלפות','סידור התחנה','ציוות','אבטחות','חתימות','כשירויות','התראות','עובדים','בקרת שעות','גישה','נתונים'],
                 adminSees:[],
                 shadow:true,
                 quals:{ work:true, edit:true },
                 board:{ work:true, edit:true }, crews:['A','B','C'],
