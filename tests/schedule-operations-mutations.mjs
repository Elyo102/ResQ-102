...
const MUTATIONS = [
  ...
  ['פערים: התקן והכשירויות סופרים שיבוץ גולמי גם כשהאדם נעדר או עזב', 'gaps',
  ...
  ['§3 שינוי מדיניות אינו מיישר את השורות הקיימות (ערבוב ישן/חדש)', 'runtime',
    ...
    "        station_id: ctx.sid, rebase_policy: false", ['editProbe']],
  ...
  ['§3 עריכה מול המדיניות הגולמית במקום ההטלה הקנונית', 'runtime',
    ...
    "    return { value: policyValue, station_map: null };", ['editProbe']],
