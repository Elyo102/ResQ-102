...
const EXPECTED_VERSION = '42H.16';
const EXPECTED_DATE = '12.9.2026';
const EXPECTED_VERSIONED_REFERENCES = 253; // 42H.16 refreshes the role-aware home experience and PWA shell.
