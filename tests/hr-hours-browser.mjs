...
async function fixture({width=1100,theme='light',connected=true}={}) {
  ...
  await context.route('**/*',async route=>{
    ...
    if(file.endsWith('hr-client.js'))body="import { createHrHoursUI } from './hr-hours-ui.js?v=42h30'; window.__UI=createHrHoursUI(document.getElementById('hr-workspace')"+(connected?',window.__adapter':'')+");";
