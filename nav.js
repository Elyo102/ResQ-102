...
// מקומות ונשכח בחמישי.
import { STAFF_ROLES, MEMBER_ROLES } from './roles.js?v=42h32';
import { attachModeChip } from './mode-bar.js?v=42h32';
import { assertPresentationOnly } from './role-view.js?v=42h32';
import { consumeActualRoleViewNavigation, isPreviewSafePage } from './role-view-page.js?v=42h32';
...
export function renderNav(claims, current, who, presentation, unreadCount) {
  ...
  import('./mode-controller.js?v=42h32')
