...
**מה השחזור אינו עושה:** אינו יוצר חשבונות Firebase Auth ואינו מתקן claims. אחרי שחזור
זהות בפרויקט מבודד, ה-UIDs בתמונה חייבים להתאים ל-Auth של אותו פרויקט — זו בדיקה
ידנית לפני כל שימוש בסביבה המשוחזרת.
