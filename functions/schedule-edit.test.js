...
test('validation: dates outside the publication, unknown station, bad kinds and limits', () => {
  ...
  throwsCode(() => edit.normalizeEdits([{ kind: 'absence', uid: 'u1', dates: ['2026-02-29'], absence: { kind: 'sick' } }], { from: '2026-02-01', to: '2026-03-31' }), 'edit-dates');
  throwsCode(() => edit.normalizeEdits([{ kind: 'absence', uid: 'u1', dates: ['2026-04-31'], absence: { kind: 'sick' } }], { from: '2026-04-01', to: '2026-05-31' }), 'edit-dates');
  throwsCode(() => edit.normalizeEdits([{ kind: 'absence', uid: 'u1', dates: ['2026-02-28'], absence: { kind: 'sick' } }], { from: '2026-02-01', to: '2026-02-31' }), 'edit-range');
  throwsCode(() => edit.normalizeEdits([{ kind: 'absence', uid: 'u1', dates: ['2026-03-02'], absence: { kind: 'sick' } }], { from: '2026-03-03', to: '2026-03-01' }), 'edit-range');
  assert.equal(edit.normalizeEdits([{ kind: 'absence', uid: 'u1', dates: ['2028-02-29'], absence: { kind: 'sick' } }], { from: '2028-02-01', to: '2028-03-31' })[0].dates[0], '2028-02-29');
