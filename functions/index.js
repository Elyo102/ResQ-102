...
exports.approveAttendanceMonth = onCall(ATTENDANCE_CORRECTION_OPTIONS,
  async req => getAttendanceCorrectionSupport().approve(req));
...
const scheduleRuntime = scheduleRuntimeModule.createScheduleRuntime({
  ...
  monthAuthorityReleaseId: '42H.29',
  FieldValue: FV,
...
exports.systemHeartbeat = onSchedule({
  ...
  await db.doc('system/heartbeat').set({
    state: 'ok', version: '42H.29', at: FV.serverTimestamp()
  }, { merge: false });
});
