 ...
 *
 * המודול אינו יודע Firebase Admin. תחנה מהטוקן ולא מהלקוח; למשתמש רגיל
 * החברות והתפקיד נקראים מחדש מתוך כרטיס התחנה החי באותה עסקה, גם בחזרה
 * על בקשה. verified super הוא החריג היחיד שאינו תלוי בכרטיס משתמש.
 * ====================================================================== */
